                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          onClick={() =>
                            handleResolveAction(selectedReport.id, "ban")
                          }
                        >
                          Ban User
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handleResolveAction(selectedReport.id, "block")
                          }
                        >
                          Block User
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handleResolveAction(selectedReport.id, "warning")
                          }
                        >
                          Send Warning
                        </button>
                        <button
                          ...
                          onClick={() =>
                            handleResolveAction(selectedReport.id, "no_action")
                          }
                        >
                          No Action Needed
                        </button>
