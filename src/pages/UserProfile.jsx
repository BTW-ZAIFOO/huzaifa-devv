              ...
              <div className="absolute -bottom-16 left-8">
                <div className="relative">
                  ...
                  <label
                    ...
                    className="absolute bottom-0 right-0 bg-gray-900 bg-opacity-80 rounded-full p-2 text-white cursor-pointer hover:bg-opacity-100"
                  >
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-start">
                                <div
                                  className={`p-2 rounded-full ${styles.icon} mr-4`}
                                >
                                  <i
                                    className={`fas ${styles.iconClass} text-lg`}
                                  ></i>
                                </div>
