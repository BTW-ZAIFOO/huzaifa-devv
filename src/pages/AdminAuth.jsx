  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-gradient-to-br from-purple-600 via-violet-500 to-indigo-500 p-5 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div
          className="absolute bottom-20 left-20 w-96 h-96 bg-violet-300 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-float"
          style={{ animationDelay: "3s" }}
        ></div>
        <div
          className="absolute top-1/3 left-1/4 w-64 h-64 bg-indigo-300 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-float"
      ...
      <div className="glass-effect w-full max-w-md rounded-3xl shadow-xl z-10 overflow-hidden mt-12">
        <div className="p-8 md:p-10">
          ...
          <div className="flex mb-8 bg-white/10 backdrop-blur-md rounded-xl relative overflow-hidden">
            ...
            <div
              className={`absolute h-full w-1/2 top-0 z-0 transition-all duration-500 ease-out rounded-xl backdrop-blur-sm bg-gradient-to-r from-purple-600/90 to-pink-600/90 shadow-lg ${
