  ...
  return (
    <footer className="bg-gradient-to-r from-blue-800 to-indigo-800 text-white pt-20 pb-8 px-5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-start flex-wrap gap-10">
        ...
        <div className="flex-[0_0_200px]">
          ...
          <ul className="list-none p-0">
            {["Home", "Features", "Technologies", "Documentation", "Support"].map((item, index) => (
              <li key={index} className="mb-3">
                <a
                  href={index === 1 ? "#features" : index === 2 ? "#technologies" : "#"}
                  className="text-white/80 no-underline transition-all flex items-center gap-2 hover:text-white hover:translate-x-1.5"
                >
        ...
        <div className="flex-[0_0_200px]">
          ...
          <div className="flex gap-4 flex-wrap">
            <Link to="https://facebook.com/profile.php?id=100030535123397&mibextid=9R9pXO" target="_blank" className="w-11 h-11 flex justify-center items-center rounded-full bg-white/10 transition-all hover:bg-indigo-500 hover:-translate-y-1">
              <img src={fb} alt="Facebook" className="w-5 h-5 brightness-0 invert" />
            </Link>
            <Link to="https://www.youtube.com/channel/UCbGtkGZ9sDg54PtU3GEDE6w" target="_blank" className="w-11 h-11 flex justify-center items-center rounded-full bg-white/10 transition-all hover:bg-indigo-500 hover:-translate-y-1">
              <i className="fab fa-youtube text-xl text-white"></i>
            </Link>
            <Link to="https://www.linkedin.com/in/muhammad-zeeshan-khan-dev/" target="_blank" className="w-11 h-11 flex justify-center items-center rounded-full bg-white/10 transition-all hover:bg-indigo-500 hover:-translate-y-1">
              <img src={linkedin} alt="LinkedIn" className="w-5 h-5 brightness-0 invert" />
            </Link>
            <Link to="https://github.com/Zeeshu911" target="_blank" className="w-11 h-11 flex justify-center items-center rounded-full bg-white/10 transition-all hover:bg-indigo-500 hover:-translate-y-1">
      ...
      <div className="text-center text-sm mt-16 pt-5 border-t border-white/10 opacity-70">
        <p className="mb-1">&copy; {new Date().getFullYear()} AI Chat Moderation System. All Rights Reserved.</p>
